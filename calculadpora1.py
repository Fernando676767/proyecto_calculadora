...
crear_boton_redondo("÷", 0, 3, TEAL, TEAL_OSCURO,
                    lambda: seleccionar_operacion("÷"))
...
crear_boton_redondo("×", 1, 3, TEAL, TEAL_OSCURO,
                    lambda: seleccionar_operacion("×"))
...
crear_boton_redondo("−", 2, 3, TEAL, TEAL_OSCURO,
                    lambda: seleccionar_operacion("-"))
...
crear_boton_redondo("+", 3, 3, TEAL, TEAL_OSCURO,
                    lambda: seleccionar_operacion("+"))
